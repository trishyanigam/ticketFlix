<x-layouts.app title="Admin Dashboard — TicketFlix">
    <div class="admin-layout">
        ...
        <main class="admin-content">
            ...
            <div class="table-container" style="background: #111113; border: 1px solid var(--border); border-radius: 24px; padding: 0; margin-bottom: 32px;">
                <div style="padding: 24px 32px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border);">
                    ...
                    <button class="btn btn-ghost btn-sm" style="border: 1px solid var(--border); border-radius: 6px;">+ Add Movie</button>
                </div>
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align: center; font-weight: 700; color: #888892;">3</td>
                            <td>
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    <div style="width: 32px; height: 32px; background: var(--surface3); border-radius: 6px; display: flex; align-items: center; justify-content: center; font-size: 16px;">⚔️</div>
                                    <div style="font-weight: 600;">Throne of Steel</div>
                                </div>
                            </td>
                            <td>Epic</td>
                            <td style="font-weight: 600;">2,910</td>
                            <td style="color: var(--green); font-weight: 600;">₹12.8L</td>
                            <td><span style="color: var(--gold);">⭐</span> 8.7</td>
                            <td>
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    <div class="progress-bar" style="flex: 1; height: 4px; background: #18181c;">
                                        <div class="progress-fill" style="width: 74%; background: var(--gold);"></div>
                                    </div>
                                    <span style="font-size: 11px; color: var(--gold); font-weight: 700; width: 30px;">74%</span>
                                </div>
                            </td>
                        </tr>
                    </tbody>
